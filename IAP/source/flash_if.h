...
#define BOOT_FLAG_ADDR			(u32)0x08001000
#define FLASH_APP_START_ADDR	(u32)0x08001800
#define FLASH_APP_END_ADDR		(u32)0x08020000
#define FLASH_IF_PRG_TIMEOUT	((u32)0x000B0000)

// stm32f07x&stm32f09x is 2K as one page,other is 1K bytes
#define FLASH_PAGE_BYTES			0x800
...
void FLASH_if_IAPEnd(u16);
void FLASH_if_EraseApp(void);
